            ...
            <div class="card">
                ...
                <div class="card-body">
                     <form method="post" action="">
                        <div class="row">
                            <input id="params" name="params" type="text" hidden="hidden" value="<?= $parameter ?>">
...
<script>
    $(document).ready(function(){
        $('#btnprint').click(function() {
            parameter = $('#params').val();
            periode = $('#periode').val();
            categori = $('#categori').val();

            window.open('<?php echo site_url("laporan/laporan_rekap_print/"); ?>'+parameter+'/'+periode+'/'+categori);
        });
    });
